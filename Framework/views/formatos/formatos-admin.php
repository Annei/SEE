    ...
    <div class="main flex">
        <div class="column formatos full">
            <div class="row-responsive">
                ...
                <div class="column align-center full">
                    <div class="row-responsive justify-center header-tittle align-center" style="background-image: url(<?php echo constant('URL'); ?>public/img/new-footer-blue.png)">
                        <div class="container-data align-center header-content justify-between">
                            ...
                            <div class="row auto"><!--Formulario para elejir el archivo a subir -->
                                <form action="" method="post" name="form_ftp" id="form_ftp"> 
                                <input name="archivo" type="file" class=""  id="archivo" />
                                <button type="submit" class="btn btn-admin bg-darkBlue color-white font-regular weight-semi">Subir archivo</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-file column bg-white align-center justify-center">
                        ...
                        <div class="hover-file row padding-semi align-center justify-center">
                            <div class="column">
                            <i class="font-triple color-white far fa-edit"></i>
                            <div class="white-space-16"></div>
