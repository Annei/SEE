            ...
            <div class="container-data">   
                ...
                <div class="grid">
                        ...
                        <form class="content column justify-center align-center" method="POST" action="crearNoticia" id="crearNoticiaForm" >
                                ...
                                <textarea class="text-admin" rows="3"  placeholder="Escriba el contenido de la Noticia aqui..." name="cuerpo" ></textarea>
                                <div class="white-space-8"></div>
                                <div class="row justify-between">
                                    <div class="icons">
                                        <div class="row">
                                            <i class="fas fa-folder font-large"></i>
                                        ...
                                        <select class="select" name="carreras" id="adminCarreras" form="crearNoticiaForm">
