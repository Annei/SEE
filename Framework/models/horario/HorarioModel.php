...
//"Materia:".$Mater."Grupo".$grup."Lunes:".$Lunes."Martes:".$Martes."Miercoles:".$Miercoles."Jueves:".$Jueves."Viernes:".$Viernes;
...
public function getPeriodo($clavedeplan)
   ...
   public function getMaterNombre($clavedemateria)
    {
        ...
        if ($con) {
          ...
          for ($i = 1; $i <= $numero_registros; $i++) {
              ...
              if (strcmp(trim($fila["MATCVE"]),trim($clavedemateria)) == 0) {
                      $aux =  $fila["MATNCO"];
                      break;
              }
